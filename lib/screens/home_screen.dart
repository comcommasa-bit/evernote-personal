        ...
        return AlertDialog(
          ...
          content: Column(
            ...
            children: AppThemeMode.values.map((mode) => ListTile(
              leading: CircleAvatar(backgroundColor: themeColors[mode], radius: 12),
    ...
    return Scaffold(
      ...
      body: Row(children: [
        _Sidebar(
          ...
          activeFolderId: _activeFolderId, activeTagId: _activeTagId,
          showTrash: _showTrash,
          onFolderTap: (id) => setState(() {
            _activeFolderId = id; _activeTagId = null; _showTrash = false;
          }),
          onTagTap: (id) => setState(() {
            _activeTagId = _activeTagId == id ? null : id;
            _activeFolderId = null; _showTrash = false;
          }),
          onTrashTap: () => setState(() {
            _showTrash = true; _activeFolderId = null; _activeTagId = null;
          }),
          onFoldersReordered: (f) async {
            _folders = f; await _db.reorderFolders(f); setState(() {});
          },
        ...
        _NoteList(
          ...
          search: _search, showTrash: _showTrash,
...
class _Sidebar extends StatefulWidget {
  ...
  const _Sidebar({
    ...
    required this.activeFolderId, required this.activeTagId,
    required this.showTrash,
    required this.onFolderTap, required this.onTagTap,
    ...
    required this.onTagRenamed, required this.onNewNote,
      ...
      child: Column(children: [
        ...
        Container(
          ...
          child: Row(children: [
            ...
            Expanded(child: Text('Evernote', style: TextStyle(
        ...
        Expanded(child: ListView(padding: EdgeInsets.zero, children: [
          ...
          _FolderTile(
            c: c, label: 'すべてのメモ',
            isActive: widget.activeFolderId == null && !widget.showTrash && widget.activeTagId == null,
...
class _NoteList extends StatelessWidget {
  ...
  const _NoteList({
    ...
    required this.count, required this.showTrash,
    required this.onSearchChanged,
    required this.onSortChanged, required this.onNoteTap,
    required this.onNewNote,
    required this.onRestoreNote, required this.onHardDeleteNote,
    required this.onExport, required this.onImport,
  });
              ...
              itemBuilder: (_) => [
                PopupMenuItem(value: 'export',
                  child: Row(children: [
                    ...
                    const SizedBox(width: 8),
                    Text('エクスポート', style: TextStyle(fontSize: 13, color: c.text)),
                  ])),
                PopupMenuItem(value: 'import',
                  child: Row(children: [
                    Icon(Icons.download_outlined, size: 16, color: c.icon),
                    const SizedBox(width: 8),
                    Text('インポート', style: TextStyle(fontSize: 13, color: c.text)),
                  ])),
              ],
            ),
          ]),
                ...
                child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  if (n.imagePaths.isNotEmpty) ...[
                    ClipRRect(
                      ...
                      child: Image.file(File(n.imagePaths.first),
                      ...
                      if (showTrash) ...[
                        ...
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              color: c.accentSoft, borderRadius: BorderRadius.circular(4)),
                            child: Text('復元',
                              style: TextStyle(fontSize: 9, color: c.accent, fontWeight: FontWeight.w600)),
                          ),
                        ),
                        const SizedBox(width: 6),
                        GestureDetector(
